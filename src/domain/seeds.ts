...
export function sampleState(): Snapshot {
 ...
 return {nodes,tags,categories,registry:[{sourceId:'demo',path:'地域データアーカイブ/01_人口・世帯',catalogId:'CAT-2026-0042',title:'人口・世帯統計',registeredAt:'2026-09-01'}],settings:{maxDepth:3,sourceId:'demo',sourceRoots:{demo:'demo:/'},excludedExtensions:[],depthPolicy:'error'},rootPath:'demo:/地域データアーカイブ',demo:true,failure:null};
}
